...
banner = """\033[36;1m
 ...
 |____/|_|   \__,_|\__\___|_|   |____/ 
     ...
     \x1b[1;97m Thanks   \033[31;1m:  \033[32mN16HT_W4RR10R
     \x1b[1;97m
"""
...
def menu():
    try:
        ...
        print("\n%s[%s!%s]%s File %s%s %sNot Found%s" % (g,m,g,k,b,passwordlist,k,W))
        exit()
...
if __name__ == '__main__':
    try:
        ...
        print("%s\nMendeteksi%s program%s dipaksa untuk berhenti %s" % (k,g,m,W))
        exit(0)